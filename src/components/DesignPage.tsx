...
const colorMap: Record<string, { light: string; base: string; dark: string }> = {
  // Tinta brand colors
  'verde-uva': { light: '#37635E', base: '#143F3B', dark: '#0d2926' },
  'paper': { light: '#EBEBEB', base: '#DBDBDB', dark: '#c4c4c4' },
  'gris-tinta': { light: '#7F7F7F', base: '#2E2E2E', dark: '#1a1a1a' },
  'rosa-vino': { light: '#DDBBC0', base: '#99757C', dark: '#7a5d63' },
  'amarillo-alegria': { light: '#E2E369', base: '#A09D4A', dark: '#807d3b' },
  'ocre-corteza': { light: '#AE8928', base: '#705622', dark: '#5a451b' },
  // Tailwind colors
